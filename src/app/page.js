...
const faqSchema = {
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What subjects does Kurisil Academy teach?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kurisil Academy specializes in Physics and Mathematics tutoring for students of all levels including Class 11, Class 12, JEE, and NEET preparation."
      }
    },
    {
      "@type": "Question",
      "name": "Where is Kurisil Academy located?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Kurisil Academy is located at 3/38 Mettu Street, Pachal (P.O), Namakkal, Tamil Nadu 637018, India."
      }
    },
    {
      "@type": "Question",
      "name": "What is the contact number for Kurisil Academy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can reach Kurisil Academy at +91 91591 29187 or via WhatsApp at the same number."
      }
    },
    {
      "@type": "Question",
      "name": "Does Kurisil Academy offer online classes?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, Kurisil Academy offers both online and offline tutoring options to suit your learning preferences."
      }
    }
  ]
};
